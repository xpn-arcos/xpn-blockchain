...
function printHelp() {
  ...
  if [ "$USAGE" == "prereq" ]; then
    ...
    println
    println " Examples:"
    println "   network.sh deployCC -ccn basic -ccp ../asset-transfer-xpn/chaincode-javascript/ ./ -ccl javascript"
    ...
    println
    println " Examples:"
    println "   network.sh deployCCAAS  -ccn basicj -ccp ../asset-transfer-xpn/chaincode-java"
    println "   network.sh deployCCAAS  -ccn basict -ccp ../asset-transfer-xpn/chaincode-typescript -ccaasdocker false" 
  elif [ "$USAGE" == "cc" ] ; then
    println "Usage: "
    ...
    println "   network.sh cc package -ccn basic -ccp chaincode/asset-transfer-xpn/go -ccv 1.0.0 -ccl go"
    ...
    println "      \033[0;32mdeployCC\033[0m - Deploy a chaincode to a channel (defaults to asset-transfer-xpn)"
